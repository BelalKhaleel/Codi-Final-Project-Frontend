    ...
    <div className="terms-of-service-page">
      ...
      <div className="section">
        ...
        <ul className="section-list">
          <p>
            Welcome to bookup! These terms and conditions govern your use of our
      ...
      <div className="section">
        ...
        <ul className="section-list">
          ...
          <p>
            You agree not to engage in any unauthorized access, use, or
            distribution of our website and its content.
          </p>
        </ul>
      </div>
      <div className="section">
        ...
        <ul className="section-list">
          <p>
            ...
            images, is the intellectual property of bookup and is protected by
      ...
      <div className="section">
        ...
        <ul className="section-list">
          <p>
            ...
            use, reproduce, modify, and distribute that content. You agree not
            to submit any content that infringes upon the rights of others or
      ...
      <div className="section">
        ...
        <ul className="section-list">
          <p>
            ...
            website, but we do not warrant the completeness, accuracy, or
            reliability of any content. In no event shall [Your Company Name] be
      ...
      <div className="privacy-policy-section">
        ...
        <ul className="section-list">
          <li>
            Information Collection: We may collect personal information from you
            when you create an account, complete a form, or interact with our
            website. We also collect usage data such as your IP address, browser
            type, and pages visited for analytical purposes.
          </li>
          <li>
            Use of Information: We use the collected information to provide and
            improve our services, communicate with you, and personalize your
            experience on our website.
          </li>
          <li>
            Information Sharing: We may share your information with trusted
            third-party service providers who assist us in operating our website
            and delivering services to you. We will not sell, trade, or disclose
            your personal information to unaffiliated third parties without your
          ...
          <li>
            User Rights: You have the right to access, update, or delete your
